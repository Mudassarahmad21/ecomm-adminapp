                     ...
                     <div className="card">
                        ...
                        <div className="card-body pt-0 p-0">
                           {tradingItem.map((elem, i) => (
                              <div className="align-items-center d-flex mx-0 border-bottom p-4" key={i}>
                                 ...
                                 <div className="me-3">
                                    ...
                                    <svg className="primary-icon" width="26" height="27" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 {elem.arrow === "green" &&
                                    <svg width={22} className="col-sm-1 col-2" height={11} viewBox="0 0 22 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M0 11L11 -4.72849e-07L22 11" fill="#21B830" />
                                    </svg>
                                 }
                                 {elem.arrow === "red" &&
                                    <svg width={22} height={11} viewBox="0 0 22 11" className="col-sm-1 col-2" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <div className="card">
                        <div className="card-body">
                           <div className="media align-items-center">
                              <span className="me-4">
                                 <svg className="primary-icon" width="50" height="53" viewBox="0 0 50 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <div className="media align-items-center">
                              <span className="me-4">
                                 <svg class="primary-icon" width="51" height="31" viewBox="0 0 51 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clip-rule="evenodd" d="M49.3228 0.840214C50.7496 2.08096 50.9005 4.24349 49.6597 5.67035L34.6786 22.8987C32.284 25.6525 28.1505 26.0444 25.281 23.7898L18.1758 18.2072L5.77023 29.883C4.3933 31.1789 2.22651 31.1133 0.930578 29.7363C-0.365358 28.3594 -0.299697 26.1926 1.07723 24.8967L13.4828 13.2209C15.9494 10.8993 19.7428 10.7301 22.4063 12.8229L29.5115 18.4055L44.4926 1.1772C45.7334 -0.249661 47.8959 -0.400534 49.3228 0.840214Z" fill="var(--primary)"></path>
                                 </svg>
                              </span>
                              <div className="media-body ms-1">
